...
import {
  ButtonDirective,
  ButtonModule
} from "./chunk-APT467VN.js";
import {
  InputText,
  InputTextModule
} from "./chunk-QAU6FTP3.js";
import {
  Dropdown,
  DropdownModule
} from "./chunk-IAKLXB7N.js";
import "./chunk-CROJNQUD.js";
import {
  TimesIcon
} from "./chunk-Y7A5LKZG.js";
import {
  SpinnerIcon
} from "./chunk-WM4XBZ3R.js";
import {
  Ripple,
  RippleModule
...
import "./chunk-5YDUZTN5.js";
import {
  BaseIcon
} from "./chunk-OJ5OFEO5.js";
import {
  DomHandler
} from "./chunk-EK2YCWCT.js";
import "./chunk-TWEMDJCR.js";
import {
  FilterService,
  Footer,
  Header,
...
var DataView = class _DataView {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function DataView_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵclassMap(ctx.styleClass);
        ɵɵproperty("ngClass", ɵɵpureFunction2(16, _c13, ctx.layout === "list", ctx.layout === "grid"))("ngStyle", ctx.style);
        ɵɵadvance();
        ...
        ɵɵadvance(2);
        ɵɵproperty("ngTemplateOutlet", ctx.itemTemplate)("ngTemplateOutletContext", ɵɵpureFunction1(19, _c23, ctx.paginator ? ɵɵpipeBind3(6, 12, ctx.filteredValue || ctx.value, ctx.lazy ? 0 : ctx.first, (ctx.lazy ? 0 : ctx.first) + ctx.rows) : ctx.filteredValue || ctx.value));
        ɵɵadvance(2);
