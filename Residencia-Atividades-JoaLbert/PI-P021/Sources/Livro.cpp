...
Livro::Livro(const string &titulo, const string &author, const int &numPaginas, const int &numDeCopiasDisponiveis) : titulo(titulo), author(author), numPaginas(numPaginas){
