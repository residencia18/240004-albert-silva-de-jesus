...
export class AuthService {
  ...
  signupUser(email: string, password: string) {
    ...
    return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBm9jnoXfIbnbhaOzUskgcdJfbCU4rmfWg',
      {
        email: email,
        password: password,
  ...
  loginUser(email: string, password: string) {
    return this.http.post<AuthResponseData>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBm9jnoXfIbnbhaOzUskgcdJfbCU4rmfWg',
      {
        email: email,
        password: password,
        returnSecureToken: true
